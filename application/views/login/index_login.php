...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Ingrese para iniciar sessión</p>
         ...
         <div class="col-xs-12">
           <table class="table table-striped">
              <tr>
                ...
                <tr>
                  <td>soporte@4nivel.com</td>
                    <td>Admin</td>
                    <td>123456</td>
                </tr>
                <tr>
                  <td>kycaza@ide.edu.ec</td>
                    <td>Stand</td>
                    <td>123456</td>
                </tr>
                 <tr>
                  <td>rguillen@pycca.com</td>
                    <td>Stand</td>
                    <td>123456</td>
                </tr>
                 <tr>
                  <td>jabvallejo@yahoo.com</td>
                     <td>Socio</td>
                    <td>123456</td>
                </tr>
                 <tr>
                  <td>cefer181@gmail.com</td>
                     <td>Socio</td>
                    <td>123456</td>
                </tr>
