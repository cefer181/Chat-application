        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom" id="element_overlap1">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Configuraciones Generales</a></li>
               <li><a href="#settings" data-toggle="tab">Cambiar contraseña</a></li>
            </ul>
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                  ...
                  <div class="form-group">
                    <label for="inputExperience" class="col-sm-2 control-label">Acerca de</label>
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal ChangePassword" action="<?=base_url('profile-password-update');?>">
                  ...
                  <div class="form-group">
                    <label for="inputEmail" required class="col-sm-2 control-label">Confirmar contraseña</label>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <button type="submit" class="btn btn-info ChangePassword">Actualizar</button>
                    </div>
                  </div>
                </form>
              </div>
    ...
    <div class="modal-dialog modal-sm">
      ...
      <form class="UploadForm">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="document_name">Cambio de foto de perfil</h4>
        </div>
        <div class="modal-body">
               <input type="file" required id="userImage">
          </div>
        <div class="modal-footer">
         <button type="submit" class="btn btn-info Upload">Subir</button>
