  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      ...
      <div class="pull-left info">
        ...
        <a href="#"><i class="fa fa-circle text-success"></i> En línea</a> </div>
    </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview <?php if($uri=='vendor/list'){ echo 'active';}?>"> <a href="#"> <i class="fa fa-users"></i> <span>Usuarios</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
        <ul class="treeview-menu">
          <li class="<?php if($uri=='vendor/list'){ echo 'active';}?>"> <a href="<?=base_url('vendor/list');?>"><i class="fa fa-list"></i>Lista</a></li>
        </ul>
      </li>
