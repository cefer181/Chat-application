        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Tu tienes un mensaje</li>
              <li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Tu tienes 1 notificación</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> 5 clientes agregados el día de hoy
                    </a>
                  </li>
                <!--  <li>
                    <a href="#">
              ...
              <li class="footer"><a href="<?=base_url('view-all-notifications');?>">Ver todos</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?=base_url('v3/profile');?>" class="btn btn-default btn-flat">Configuración</a>
                </div>
